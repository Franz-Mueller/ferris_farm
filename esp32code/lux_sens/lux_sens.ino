// Source: https://www.14core.com/wiring-the-tls2591-high-range-lux-light-intensity-ambient-light-sensor-on-microcontroller/
...
void displaySensorDetails(void)
{
  ...
  tsl.getSensor(&sensor);
   Serial.println("14CORE | TLS2591 TEST CODE ");
  Serial.println("------------------------------------");
